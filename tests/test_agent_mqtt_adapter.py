...
class TestAgentMQTTAdapter(unittest.TestCase):
    ...
    def test_on_message_valid_data(self):
        ...
        valid_json_data = '{"accelerometer": {"x": 0.1, "y": 0.2, "z": 0.3}, "gps": {"latitude": 10.123, "longitude": 20.456}, "timestamp": "2023-07-21T12:34:56Z"}'
        ...
        self.mock_store_gateway.save_data.assert_called_once_with(
            process_agent_data(expected_agent_data)
        )
    ...
    def test_on_message_invalid_data(self):
        ...
        invalid_json_data = '{"accelerometer": {"x": 0.1, "y": 0.2}, "gps": {"latitude": 10.123}, "timestamp": 12345}'
